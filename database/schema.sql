...
(
	...
	pmc_id text,
	section_body xml,
	section_title_string varchar(512),
	pubmedid integer,
	distance double precision,
	pubmed_id_tolower integer,
	distance_tolower double precision,
	avg_distancetolower double precision
);

alter table article_heading owner to postgres;

create index article_heading_distance_tolower_index
	on article_heading (distance_tolower desc);

create index article_heading_pubmed_id_tolower_index
	on article_heading (pubmed_id_tolower);

create index article_heading_pubmedid_index
	on article_heading (pubmedid);

create unique index article_heading_article_id_section_number_uindex
	on article_heading (article_id, section_number);

create index article_heading_distance_index
	on article_heading (distance desc);

create index article_heading_pmc_id_index
	on article_heading (pmc_id);

create index article_heading_section_title_string_index
	on article_heading (section_title_string);
...
create index articles_pmcid_index
	on articles (pmcid);

create index articles_pmid_index
	on articles (pmid);

create index articles_title_index
	on articles (title);

create table fasttext_negative_examples
(
	articleid integer not null
		constraint fasttext_negative_examples_pk
			primary key
);

alter table fasttext_negative_examples owner to postgres;

create unique index fasttext_negative_examples_articleid_uindex
	on fasttext_negative_examples (articleid);

create table german
(
	pmid text not null
		constraint german_pk
			primary key
);

alter table german owner to postgres;

create unique index german_article_id_uindex
	on german (pmid);
...
alter table negative_examples owner to postgres;

create unique index negative_examples_article_id_uindex
	on negative_examples (article_id);

create table newwikiheadings
(
	heading varchar(512),
	label varchar(512),
	id serial not null
		constraint newwikiheadings_pk
			primary key
);

alter table newwikiheadings owner to postgres;

create index newwikiheadings_heading_index
	on newwikiheadings (heading);

create index newwikiheadings_label_index
	on newwikiheadings (label);

create unique index newwikiheadings_id_uindex
	on newwikiheadings (id);
...
alter table positive_examples owner to postgres;

create unique index positiveexamples_article_id_uindex
	on positive_examples (article_id);

create table relevance_confidence
(
	article_id integer not null,
	relevant_confidence double precision not null,
	notrelevant_confidence double precision not null
);

alter table relevance_confidence owner to postgres;

create unique index relevance_confidence_article_id_uindex
	on relevance_confidence (article_id);

create table relevance_confidence2
(
	article_id integer,
	notrelevant_confidence double precision,
	relevant_confidence double precision
);

alter table relevance_confidence2 owner to postgres;

create index relevance_confidence2_article_id_index
	on relevance_confidence2 (article_id);

create index relevance_confidence2_relevant_confidence_index
	on relevance_confidence2 (relevant_confidence desc);

create table relevance_confidence3
(
	article_id integer,
	relevant_confidence double precision,
	notrelevant_confidence double precision
...
alter table relevance_confidence3 owner to postgres;

create unique index relevance_confidence_3_article_id_uindex
	on relevance_confidence3 (article_id);
...
create unique index test_article_id_uindex
	on test (pmid);
...
create unique index training_article_id_uindex
	on training (article_id);

create table trec_cds_2015
(
	pmid integer not null
		constraint trec_cds_2015_pk
			primary key
);

alter table trec_cds_2015 owner to postgres;

create unique index trec_cds_2015_pmid_uindex
	on trec_cds_2015 (pmid);
...
create unique index validation_article_id_uindex
	on validation (article_id);

create table wiki_headings
(
	heading varchar(512),
	label varchar(512),
	docs double precision,
	h double precision,
	cumm integer,
	cumm_percent double precision,
	freq integer,
	rank integer not null
		constraint wiki_headings_pk
			primary key
);

alter table wiki_headings owner to postgres;

create index wiki_headings_heading_index
	on wiki_headings (heading);

create unique index wiki_headings_rank_uindex
	on wiki_headings (rank);

create table wikisection_v2
(
	id serial not null
		constraint wikisection_v2_pk
			primary key,
	heading text,
	label text
);

alter table wikisection_v2 owner to postgres;

create unique index wikisection_v2_id_uindex
	on wikisection_v2 (id);

create index wikisection_v2_heading_index
	on wikisection_v2 (heading);
...
create view pg_catalog.pg_stat_wal_receiver(conninfo, last_msg_receipt_time, last_msg_send_time, latest_end_lsn, latest_end_time, pid, receive_start_lsn, receive_start_tli, received_lsn, received_tli, slot_name, status) as
-- missing source code
;
...
create view information_schema.table_constraints(constraint_catalog, constraint_name, constraint_schema, constraint_type, initially_deferred, is_deferrable, table_catalog, table_name, table_schema) as
-- missing source code
;
...
create function pg_catalog.abstime(timestamp with time zone) returns abstime
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.abstime(timestamp) returns abstime
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.abstimeeq(abstime, abstime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.abstimege(abstime, abstime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.abstimegt(abstime, abstime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.abstimein(cstring) returns abstime
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.abstimele(abstime, abstime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.abstimelt(abstime, abstime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.abstimene(abstime, abstime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.abstimeout(abstime) returns cstring
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.abstimerecv(internal) returns abstime
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.abstimesend(abstime) returns bytea
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.btabstimecmp(abstime, abstime) returns integer
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.btreltimecmp(reltime, reltime) returns integer
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.bttintervalcmp(tinterval, tinterval) returns integer
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.date(abstime) returns date
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.gist_box_compress(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.gist_box_decompress(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.gist_box_fetch(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.gtsquery_decompress(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.inet_gist_decompress(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.interval(reltime) returns interval
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.interval_transform(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.intinterval(abstime, tinterval) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.isfinite(abstime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.mktinterval(abstime, abstime) returns tinterval
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.numeric_transform(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.pg_control_checkpoint(out checkpoint_lsn pg_lsn, out checkpoint_time timestamp with time zone, out full_page_writes boolean, out newest_commit_ts_xid xid, out next_multi_offset xid, out next_multixact_id xid, out next_oid oid, out next_xid text, out oldest_active_xid xid, out oldest_commit_ts_xid xid, out oldest_multi_dbid oid, out oldest_multi_xid xid, out oldest_xid xid, out oldest_xid_dbid oid, out prev_timeline_id integer, out prior_lsn pg_lsn, out redo_lsn pg_lsn, out redo_wal_file text, out timeline_id integer) returns record
	strict
	cost 1
	language internal
as $$
...
comment on function pg_catalog.pg_control_checkpoint(out pg_lsn, out timestamp with time zone, out boolean, out xid, out xid, out xid, out oid, out text, out xid, out xid, out oid, out xid, out xid, out oid, out integer, out pg_lsn, out pg_lsn, out text, out integer) is 'pg_controldata checkpoint state information as a function';
...
create function pg_catalog.pg_create_logical_replication_slot(out lsn pg_lsn, plugin name, slot_name name, out slot_name text, temporary boolean default false) returns record
	strict
	cost 1
	language internal
as $$
...
create function pg_catalog.pg_get_object_address(args text[], out classid oid, name text[], out objid oid, out objsubid integer, type text) returns record
	stable
	strict
	cost 1
	language internal
...
comment on function pg_catalog.pg_get_object_address(text[], out oid, text[], out oid, out integer, text) is 'get OID-based object address from name/args arrays';
...
create function pg_catalog.pg_stat_get_progress_info(cmdtype text, out datid oid, out param1 bigint, out param10 bigint, out param2 bigint, out param3 bigint, out param4 bigint, out param5 bigint, out param6 bigint, out param7 bigint, out param8 bigint, out param9 bigint, out pid integer, out relid oid) returns setof record
	stable
	strict
	cost 1
	rows 100
...
create function pg_catalog.pg_stat_get_wal_receiver(out conninfo text, out last_msg_receipt_time timestamp with time zone, out last_msg_send_time timestamp with time zone, out latest_end_lsn pg_lsn, out latest_end_time timestamp with time zone, out pid integer, out receive_start_lsn pg_lsn, out receive_start_tli integer, out received_lsn pg_lsn, out received_tli integer, out slot_name text, out status text) returns record
	stable
	cost 1
	language internal
as $$
...
comment on function pg_catalog.pg_stat_get_wal_receiver(out text, out timestamp with time zone, out timestamp with time zone, out pg_lsn, out timestamp with time zone, out integer, out pg_lsn, out integer, out pg_lsn, out integer, out text, out text) is 'statistics: information about WAL receiver';

create function pg_catalog.pg_stat_get_wal_senders(out flush_lag interval, out flush_lsn pg_lsn, out pid integer, out replay_lag interval, out replay_lsn pg_lsn, out sent_lsn pg_lsn, out state text, out sync_priority integer, out sync_state text, out write_lag interval, out write_lsn pg_lsn) returns setof record
	stable
	cost 1
	rows 10
	language internal
...
create function pg_catalog.range_gist_compress(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.range_gist_decompress(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.range_gist_fetch(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.reltime(interval) returns reltime
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.reltimeeq(reltime, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.reltimege(reltime, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.reltimegt(reltime, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.reltimein(cstring) returns reltime
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.reltimele(reltime, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.reltimelt(reltime, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.reltimene(reltime, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.reltimeout(reltime) returns cstring
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.reltimerecv(internal) returns reltime
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.reltimesend(reltime) returns bytea
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.smgreq(smgr, smgr) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.smgrin(cstring) returns smgr
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.smgrne(smgr, smgr) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.smgrout(smgr) returns cstring
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.time_transform(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.timemi(abstime, reltime) returns abstime
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.timenow() returns abstime
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.timepl(abstime, reltime) returns abstime
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.timestamp(abstime) returns timestamp
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.timestamp_izone_transform(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.timestamp_transform(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.timestamp_zone_transform(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.timestamptz(abstime) returns timestamp with time zone
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tinterval(abstime, abstime) returns tinterval
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalct(tinterval, tinterval) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalend(tinterval) returns abstime
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervaleq(tinterval, tinterval) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalge(tinterval, tinterval) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalgt(tinterval, tinterval) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalin(cstring) returns tinterval
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalle(tinterval, tinterval) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalleneq(tinterval, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervallenge(tinterval, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervallengt(tinterval, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervallenle(tinterval, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervallenlt(tinterval, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervallenne(tinterval, reltime) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervallt(tinterval, tinterval) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalne(tinterval, tinterval) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalout(tinterval) returns cstring
	stable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalov(tinterval, tinterval) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalrecv(internal) returns tinterval
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalrel(tinterval) returns reltime
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalsame(tinterval, tinterval) returns boolean
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalsend(tinterval) returns bytea
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.tintervalstart(tinterval) returns abstime
	immutable
	strict
	cost 1
	language internal
...
comment on function pg_catalog.to_tsvector(json) is 'transform json to tsvector';
...
comment on function pg_catalog.to_tsvector(jsonb) is 'transform jsonb to tsvector';
...
comment on function pg_catalog.to_tsvector(regconfig, json) is 'transform json to tsvector';
...
comment on function pg_catalog.to_tsvector(regconfig, jsonb) is 'transform jsonb to tsvector';
...
create function pg_catalog.varbit_transform(internal) returns internal
	immutable
	strict
	cost 1
	language internal
...
create function pg_catalog.varchar_transform(internal) returns internal
	immutable
	strict
	cost 1
	language internal
